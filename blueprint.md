...
- `style.css`: All styling rules, including the new contact form styles.
- `main.js`: Interactive logic (typing effect, theme toggle, mobile menu, stats counter).

## Latest Changes
- Added "Affiliate Inquiry" section with a Formspree form (`https://formspree.io/f/mvzwypvo`).
- Added theme-responsive styling for the contact form in `style.css`.
- Updated navigation to include "제휴 문의".
